...
const Tlf_9 = () => {
  ...
  const getGriddata = (
    ...
    // Axios.get(
    //   `http://${window.location.hostname}:3005/TLF_9_Combined/${StartDate}/${EndDate}/${value1}/${value2}`
    // ).then((result) => {
    ...
    //   }
    // });
    AnalyticAxios.get(`/api/GridChart/TLF_9_Combined/${StartDate}/${EndDate}/${value1}/${value2}`)
    .then((result) => {
  ...
  const loadData = (StartDate, EndDate, value1, value2) => {
    getGriddata("TLF_9_Combined", StartDate, EndDate, value1, value2);
  ...
  return isLoggedin ? (
    <div className="main">
      ...
      <div style={{ fontSize: "20px" }}>
        ...
        To:{"   "}
        <u>
          <strong>Lic Exit Gate Time{"   "}</strong>
        </u>
        {"   "}
      </div>
