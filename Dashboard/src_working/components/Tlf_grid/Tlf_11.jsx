...
const DropDownItems1 = [
  { label: "LicEntryGateTime", key: "LicEntryGateTime" },

  { label: "LoadingEndTime", key: "LoadingEndTime" },
];

const DropDownItems2 = [
  { label: "BayReportingTime", key: "BayReportingTime" },

  { label: "LicExitGateTime", key: "LicExitGateTime" },
];
...
const Tlf_11 = () => {
  ...
  const [selectedColumn1, setSelectedColumn1] = useState("LicEntryGateTime");
  const [selectedColumn2, setSelectedColumn2] = useState("BayReportingTime");
  ...
  const getGriddata = (
    ...
    if (spName === "TLF_16_Combined") {
      // Axios.get(
      //   `http://${window.location.hostname}:3005/TLF_16_Combined/${StartDate}/${EndDate}/${value1}/${value2}/${selectedColumn1}/${selectedColumn2}`
      // ).then((result) => {
      ...
      //   }
      // });
      AnalyticAxios.get(`/api/BarChart/TLF_16_Combined/${StartDate}/${EndDate}/${value1}/${value2}/${selectedColumn1}/${selectedColumn2}`)
      .then((result) => {
        const sumTTOccurence = result.data.recordset.reduce((total, record) => {
          return total + record["Result Count"];
        }, 0);
  ...
  return isLoggedin ? (
    <div className="main">
      ...
      <div>
        ...
        Cycle Time From:{"   "}
        <select
          onChange={onClickDropDown1}
          defaultValue={"MainEntryGateTime"}
          style={{
            height: "31px",
            borderRadius: "5px",
          }}
        ...
        To:{"   "}
        <select
          onChange={onClickDropDown2}
          defaultValue={"MainExitGateTime"}
          style={{
            height: "31px",
            borderRadius: "5px",
          }}
