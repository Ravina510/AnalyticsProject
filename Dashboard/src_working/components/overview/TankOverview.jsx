    ...
    <>
      ...
      <div style={{ justifyContent: "center", border: "solid", color: "gray",height:'100%' }}>
        ...
        <iframe
          ...
          // src={'http://' + hostName + ':3005/eServer/PageLoader.asp?page=TANK_FARM.htm'}

          src={'http://10.68.102.67/eServer/PageLoader.asp?page=TANK_FARM.htm'}
          width={'100%'}
          height={'100%'}
          title="Tank Overview"
        />
    ...
    <>
      ...
      <div style={{ justifyContent: "center", border: "solid", color: "gray",height:'100%' }}>
        ...
        <iframe
          ...
          src={'http://10.68.102.67/eServer/PageLoader.asp?page=PUMP_OVERVIEW.htm'}
          width={'100%'}
          height={'100%'}
          title="Pump Overview"
        />
    ...
    <>
      ...
      <div style={{ justifyContent: "center", border: "solid", color: "gray",height:'100%' }}>
        ...
        <iframe
          ...
          src={'http://10.68.102.67/eServer/PageLoader.asp?page=FIRE_ENGINE_PUMP.htm'}
          width={'100%'}
          height={'100%'}
    ...
    <>
      ...
      <div style={{ justifyContent: "center", border: "solid", color: "gray" ,height:'100%'}}>
        ...
        <iframe
          ...
          src={'http://10.68.102.67/eServer/PageLoader.asp?page=CRITICAL_ALARM.htm'}
          width={'100%'}
          height={'100%'}
